...
void handle_provide_token(void *parameters)
{
    ...
    if (msg->item1) {
        ...
        // If we wanted to add a screen, say a warning screen for example, we could
        // instruct the ethereum app to add an additional screen by setting
        // `msg->additionalScreens` here, just like so: msg->additionalScreens = 1;
    }
